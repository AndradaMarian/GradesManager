 ...
 * an SQLException to the application to notify it of the same error. Nota that automatic closing of a Connection object as discussed in the previous section
