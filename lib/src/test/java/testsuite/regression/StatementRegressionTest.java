...
public class StatementRegressionTest extends BaseTestCase {
    ...
    public void testServerPrepStmtAndDate() throws Exception {
        ...
        Date dt = new java.sql.Date(102, 1, 2); // Nota, this represents the date 2002-02-02
     ...
     * 
     * Nota: The properties 'useJDBCCompliantTimezoneShift' and 'useSSPSCompatibleTimezoneShift' no longer exist in Connector/J 6.0.
     * 
     * @throws Exception
     *             if the test fails
     */
     ...
     * 
     * Nota that to get this scenario to work with MySQL (since it doesn't support per-value timezones), you need to configure your server (or session) to be in
